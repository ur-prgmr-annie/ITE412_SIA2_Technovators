// src/pages/program3/Program3Layout.jsx
...
const NAV = [
  ...
  { to: "case-reporting", label: "Case Reporting", icon: FilePlus2 },
  { to: "case-monitoring", label: "Case Monitoring", icon: ClipboardList },
  { to: "status-tracking", label: "Status Tracking", icon: Workflow },
  { to: "gis-hotspots", label: "GIS Hotspots", icon: Map },
  { to: "reports", label: "Reports & Trends", icon: Activity },
];
...
export default function Program3Layout() {
      ...
      <aside className={`pl-side-nav ${mobileOpen ? "expanded" : ""} ${sidebarMinimized ? "minimized" : ""}`}>
        ...
        <div className="pl-sidebar-header-wide">
          ...
          <div className="pl-app-info-wide">
            <div className="pl-program-badge-wide">PROGRAM 3</div>
            <div className="pl-app-title-wide">Animal Health Care</div>
        ...
        <header className="pl-top-bar-wide">
          <div className="pl-top-left-section">
            ...
            <div className="pl-desktop-navigation-wide">
              ...
              <span className="pl-current-page-wide">Animal Health Care</span>
            </div>
          </div>
          ...
          <div className="pl-top-center-section">
            <div className="pl-welcome-section-wide">
              ...
              <p className="pl-welcome-subtitle-wide">
                Track disease surveillance, case status, and hotspots
              </p>
            </div>
          </div>
          ...
          <div className="pl-footer-content-wide">
            <div className="pl-footer-left-wide">
              <span className="pl-footer-text-wide">
                © 2024 Municipal Agriculture Office of Naujan • ANIMIS
              </span>
            </div>
            <div className="pl-footer-right-wide">
              <span className="pl-version-wide">v1.0.0 • Professional Edition • All Systems Operational</span>
            </div>
          </div>
        </footer>
      </main>
